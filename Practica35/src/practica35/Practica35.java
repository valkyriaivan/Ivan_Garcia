...
public class Practica35 {
    ...
    public static void main(String[] args) {
        ...
        modPi = 4 * resultadoPi; //Pi es igual a resultadoPi por 4
        BigDecimal piBig = new BigDecimal(modPi); //Creamos variable BigDecimal
